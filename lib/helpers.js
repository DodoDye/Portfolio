...
// Parse a JSON string to an object in all cases, without throwing
helpers.parseStrToObject = function(str){
  try {
...
// Parse cookies from request
helpers.stringifyCookies = function(cookies) {
    var list = [ ];
...
helpers.getDate = function(millis){
    var now = new Date(new Date().toUTCString() + "-0100");
